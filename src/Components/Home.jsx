...
function Home(){
  return(
    ...
    <div className="bg-[orange]">
      <div className=" max-w-[800px] w-full font- h-screen mx-auto text-center flex flex-col justify-center">
      <p className="text-[#a30000be] font- font-bold ">Buy with Us</p>
        <p className="md:text-7xl sm:text-6xl text-4xl font-bold ">Everything you needs</p>
        <div>
          <p className="md:text-5xl sm:text-4xl text-xl font-bold pt-4">Free</p>
      </div>
      </div>
    </div>
    </>
